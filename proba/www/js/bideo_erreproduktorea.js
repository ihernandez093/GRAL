...
function balioakHasieratu(){
	balioak=[];
	nextsrc=[];
	balioak=getBalio();
	console.log(balioak);
	for(var i=0;i<balioak.length;i++) {
		  console.log(balioak[i]);		  
		  nextsrc.push("video/"+balioak[i]+".mp4");
			console.log(nextsrc);
			console.log("Luzeera:"+nextsrc.length);
		}
	media.src="video/"+balioak[0]+".mp4"
}
...
document.body.onload = elementuaGehitu();

function elementuaGehitu(){
